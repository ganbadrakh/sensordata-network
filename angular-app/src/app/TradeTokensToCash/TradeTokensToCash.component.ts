...
import { TradeTokensToCashService } from './TradeTokensToCash.service';
import 'rxjs/add/operator/toPromise';
@Component({
	selector: 'app-TradeTokensToCash',
	templateUrl: './TradeTokensToCash.component.html',
	styleUrls: ['./TradeTokensToCash.component.css'],
  providers: [TradeTokensToCashService]
})
export class TradeTokensToCashComponent implements OnInit {
  ...
  constructor(private serviceTradeTokensToCash:TradeTokensToCashService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    let tempList = [];
    return this.serviceTradeTokensToCash.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: "org.acme.biznet.TradeTokensToCash",
    ...
    return this.serviceTradeTokensToCash.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
			this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceTradeTokensToCash.updateTransaction(form.get("transactionId").value,this.Transaction)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceTradeTokensToCash.deleteTransaction(this.currentId)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  getForm(id: any): Promise<any>{
    ...
    return this.serviceTradeTokensToCash.getTransaction(id)
    .toPromise()
    .then((result) => {
			this.errorMessage = null;
      let formObject = {
