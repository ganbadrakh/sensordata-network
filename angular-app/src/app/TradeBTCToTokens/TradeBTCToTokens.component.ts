...
import { TradeBTCToTokensService } from './TradeBTCToTokens.service';
import 'rxjs/add/operator/toPromise';
@Component({
	selector: 'app-TradeBTCToTokens',
	templateUrl: './TradeBTCToTokens.component.html',
	styleUrls: ['./TradeBTCToTokens.component.css'],
  providers: [TradeBTCToTokensService]
})
export class TradeBTCToTokensComponent implements OnInit {
  ...
  constructor(private serviceTradeBTCToTokens:TradeBTCToTokensService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    let tempList = [];
    return this.serviceTradeBTCToTokens.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: "org.acme.biznet.TradeBTCToTokens",
    ...
    return this.serviceTradeBTCToTokens.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
			this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceTradeBTCToTokens.updateTransaction(form.get("transactionId").value,this.Transaction)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceTradeBTCToTokens.deleteTransaction(this.currentId)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  getForm(id: any): Promise<any>{
    ...
    return this.serviceTradeBTCToTokens.getTransaction(id)
    .toPromise()
    .then((result) => {
			this.errorMessage = null;
      let formObject = {
