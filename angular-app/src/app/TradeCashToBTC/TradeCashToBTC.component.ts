...
import { TradeCashToBTCService } from './TradeCashToBTC.service';
import 'rxjs/add/operator/toPromise';
@Component({
	selector: 'app-TradeCashToBTC',
	templateUrl: './TradeCashToBTC.component.html',
	styleUrls: ['./TradeCashToBTC.component.css'],
  providers: [TradeCashToBTCService]
})
export class TradeCashToBTCComponent implements OnInit {
  ...
  constructor(private serviceTradeCashToBTC:TradeCashToBTCService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    let tempList = [];
    return this.serviceTradeCashToBTC.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: "org.acme.biznet.TradeCashToBTC",
    ...
    return this.serviceTradeCashToBTC.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
			this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceTradeCashToBTC.updateTransaction(form.get("transactionId").value,this.Transaction)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceTradeCashToBTC.deleteTransaction(this.currentId)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  getForm(id: any): Promise<any>{
    ...
    return this.serviceTradeCashToBTC.getTransaction(id)
    .toPromise()
    .then((result) => {
			this.errorMessage = null;
      let formObject = {
