    ...
    .then((result) => {
      ...
      let formObject = {
        ...
        if(result.sensorType){
            ...
            formObject.sensorType = result.sensorType;
          
        }else{
          formObject.sensorType = null;
        }
      
        if(result.sensorName){
          
            formObject.sensorName = result.sensorName;
          
        }else{
          formObject.sensorName = null;
        }
        ...
        if(result.firmware){
            ...
            formObject.firmware = result.firmware;
          
        }else{
          formObject.firmware = null;
        }
