...
function TradeAirPollutionData(tradeData) {
    ...
    console.log('#### seller cash balance before: ' + tradeData.toWallet.balance);
    tradeData.toWallet.balance += tradeData.amount;
    console.log('#### seller cash balance after: ' + tradeData.toWallet.balance);
    //update values of the buyer account
    console.log('#### buyer cash balance before: ' + tradeData.fromWallet.balance);  
    tradeData.fromWallet.balance -= tradeData.amount;
    console.log('#### buyer cash balance after: ' + tradeData.fromWallet.balance); 
...
function ProvideExtendedData(forwardData) {
    ...
    if(extendeddata.status !== 'PROCESSED'){
